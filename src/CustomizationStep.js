...
const CustomizationStep = ({ loadingMessage, setLoadingMessage, vantaHighlight, setVantaHighlight, vantaMidtone, setVantaMidtone, vantaLowlight, setVantaLowlight, handleCreateGame }) => {
  return (
